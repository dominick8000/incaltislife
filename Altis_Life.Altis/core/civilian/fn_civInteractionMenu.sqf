/*  File Original: fn_copInteractionMenu.sqf
    ...
    Description:
    Erlaubt das Kidnappen, Eskotieren und Transportieren von Geiseln
*/
#define Btn1 37450  //Handschellen abnehmen
#define Btn4 37453  //Eskortieren
#define Btn7 37456  //In Auto packen
#define Title 37401
